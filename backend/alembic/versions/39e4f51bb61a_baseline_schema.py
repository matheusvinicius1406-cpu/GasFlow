...
Revision ID: 39e4f51bb61a
Revises: 
Create Date: 2026-08-09 18:59:13.551540
...
def upgrade() -> None:
    ...
    with op.batch_alter_table('clients', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_clients_codigo'), ['codigo'], unique=True)
    ...
    with op.batch_alter_table('delivery_drivers', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_delivery_drivers_codigo'), ['codigo'], unique=True)
    ...
    with op.batch_alter_table('products', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_products_codigo'), ['codigo'], unique=True)
    ...
    with op.batch_alter_table('orders', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_orders_codigo'), ['codigo'], unique=True)
